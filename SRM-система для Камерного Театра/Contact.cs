...
namespace SRM_система_для_Камерного_Театра
{
    public partial class Contact : UserControl
    {
        ...
        public void GetListUsers()
        {
            ...
            string commandStr = "SELECT c_id AS 'Код', c_fio AS 'ФИО', c_position AS 'Должность', " +
                "с_responsible AS 'Ответственный', c_number AS 'Номер телефона', " +
                "c_email AS 'Email', c_datecall AS 'Дата звонка', c_timecall 'Время звонка' FROM t_contacts";
